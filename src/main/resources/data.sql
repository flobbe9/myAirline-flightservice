...
INSERT INTO flight(id, number, airline_name, departure_airport_name, arrival_airport_name, departure_time, arrival_time, departure_date, arrival_date, base_price, num_normal_seats, num_corridor_seats, num_window_seats, num_foot_room_seats, num_available_seats) VALUES(4, 4, 'Turkish Airlines', 'Hannover airport', 'Frankfurt airport', '22:00', '23:00', CURDATE() + 1, CURDATE() + 1, 30.0, 40, 10, 10, 10, 70);
